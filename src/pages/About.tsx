  ...
  const teamMembers = [
    {
      ...
      role: "Marine Biologist & Project Lead",
      description: "Specialist in marine biodiversity with 15+ years of research experience."
    },
    {
      name: "Alex Chen",
      role: "Full-Stack Developer", 
      description: "Expert in React, Node.js, and database systems with a passion for environmental tech."
    },
    {
      name: "Dr. James Wilson",
      role: "Data Scientist",
      description: "AI/ML specialist focused on marine data analysis and predictive modeling."
    },
    {
      name: "Emma Rodriguez",
      role: "UX/UI Designer",
      description: "Creates intuitive interfaces for complex scientific data visualization."
    }
  ];
